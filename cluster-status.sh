#!/bin/bash
# ============================================================
# cluster-status.sh v2 - Status report for Proxmox VE clusters
# ============================================================
# Formaty:
...
#   ./cluster-status.sh -h
#
# Repo: github.com/werwinski/proxmox-cluster-status
# Wersja: 2.0
# ============================================================
...
<footer>
  ...
  Repo: <a href="https://github.com/werwinski/proxmox-cluster-status" style="color:#3498db">werwinski/proxmox-cluster-status</a>
</footer>
</div>
